...
$APPLICATION->SetTitle("Планировщик"); 
$arCategoryUsers = getCategoryUsers(15);
$arMailingRubric = getMailingRubric();
$actionForm = "/ajax/mailing-planner-filter.php";
        ...
        <div class="containered">
                ...
                <ul class="sidebar__list">
                    ...
                    <li class="sidebar__item active">
                        ...
                        <div class="sidebar__tab-content" style="display: block;">
                            ...
                            <a class="sidebar__link sidebar__link-tab active" href="/admin/subscribe/mailer/planner/">Планировщик</a>
            ...
            <div class="main-content newsletter newsletter-search__content mailing-filter">
                ...
                <div class="newsletter__tab-content active">
                    ...
                    <?$GLOBALS['arrFilterTemplateF'] = array(
                        'PROPERTY_CATEGORY_USERS_VALUE' => $arCategoryUsers[7]["VALUE"],
                        array(
                            "LOGIC" => "OR",
                    ...
                    $APPLICATION->IncludeComponent("deus:news.list","mailing-planner",Array(
                                ...
                                "FIELD_CODE" => Array("ID", "DATE_ACTIVE_FROM", "DATE_ACTIVE_TO"),
                                "PROPERTY_CODE" => Array("RUBRIC", "USERS", "COUNTER", "CATEGORY_USERS","DATE_SEND"),
                                "CHECK_DATES" => "N",
                                "CHECK_ACTIVE" => "N",
                                "DETAIL_URL" => "",
                ...
                <div class="newsletter__tab-content">
                    ...
                    <?$GLOBALS['arrFilterTemplateU'] = array(
                        'PROPERTY_CATEGORY_USERS_VALUE' => $arCategoryUsers[8]["VALUE"],
                        array(
                            "LOGIC" => "OR",
                            array(">DATE_ACTIVE_TO"=>date($DB->DateFormatToPHP(CLang::GetDateFormat()), time())),
                            array("DATE_ACTIVE_TO"=>false),
