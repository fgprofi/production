...
$APPLICATION->SetTitle("Архив рассылок"); 
$arCategoryUsers = getCategoryUsers(15);
$arMailingRubric = getMailingRubric();
$actionForm = "/ajax/mailing-archive-filter.php";
    ...
    <div class="content">
        <div class="containered">
                ...
                <ul class="sidebar__list">
                    ...
                    <li class="sidebar__item active">
                        ...
                        <div class="sidebar__tab-content" style="display: block;">
                            ...
                            <a class="sidebar__link sidebar__link-tab active" href="/admin/subscribe/mailer/history/">Архив рассылок</a>
                        </div>
                    </li>
            ...
            <div class="main-content newsletter newsletter-search__content mailing-filter">
                ...
                <div class="newsletter__heading">Архив рассылок</div>
                ...
                <div class="newsletter__tab-content active">
                    <form class="newsletter__form" action="<?=$actionForm?>">
                        ...
                        <input type="text" class="newsletter__input input__search" name="name-text" placeholder="Искать по названию, дате">
                    ...
                    <?$GLOBALS['arrFilterArchiveF'] = array('!DATE_ACTIVE_TO' => false, 'PROPERTY_CATEGORY_USERS_VALUE' => $arCategoryUsers[7]["VALUE"]);
                ...
                <div class="newsletter__tab-content">
                    ...
                    <?$GLOBALS['arrFilterArchiveU'] = array('!DATE_ACTIVE_TO' => false, 'PROPERTY_CATEGORY_USERS_VALUE' => $arCategoryUsers[8]["VALUE"]);
                    $APPLICATION->IncludeComponent("deus:news.list","mailing-archive",Array(
                            "AJAX_MODE" => "N",
                            "IBLOCK_TYPE" => "mailing",
                            "IBLOCK_ID" => "15",
