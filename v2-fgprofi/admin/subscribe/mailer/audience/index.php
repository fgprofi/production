...
$APPLICATION->SetTitle("Аудитории"); 
$arCategoryUsers = getCategoryUsers(17);
$arMailingRubric = getMailingRubric();
$actionForm = "/ajax/mailing-audience-filter.php";
    ...
    <div class="content">
        <div class="containered">
                ...
                <ul class="sidebar__list">
                    ...
                    <li class="sidebar__item active">
                        ...
                        <div class="sidebar__tab-content" style="display: block;">
                            ...
                            <a class="sidebar__link sidebar__link-tab active" href="/admin/subscribe/mailer/audience/">Аудитории</a>
            ...
            <div class="main-content newsletter newsletter-search__content mailing-filter">
                ...
                <div class="newsletter__heading">Аудитории</div>
                ...
                <div class="newsletter__tab-content active">
                    ...
                    <?$GLOBALS['arrFilterAudienceF'] = array('PROPERTY_CATEGORY_USERS_VALUE' => $arCategoryUsers[7]["VALUE"]);
                    $APPLICATION->IncludeComponent("bitrix:news.list","mailing-audience",Array(
                                ...
                                "SORT_BY2" => "SORT",
                                "SORT_ORDER2" => "ASC",
                                "FILTER_NAME" => "arrFilterAudienceF",
                                "FIELD_CODE" => Array("ID"),
                ...
                <div class="newsletter__tab-content">
                    ...
                    <?$GLOBALS['arrFilterAudienceU'] = array('PROPERTY_CATEGORY_USERS_VALUE' => $arCategoryUsers[8]["VALUE"]);
                    $APPLICATION->IncludeComponent("bitrix:news.list","mailing-audience",Array(
                                "AJAX_MODE" => "N",
                                "IBLOCK_TYPE" => "mailing",
                                "IBLOCK_ID" => "16",
                                ...
                                "SORT_BY2" => "SORT",
                                "SORT_ORDER2" => "ASC",
                                "FILTER_NAME" => "arrFilterAudienceU",
                                "FIELD_CODE" => Array("ID"),
                                "PROPERTY_CODE" => Array("DATE_CREATE", "USERS", "COUNTER", "CATEGORY_USERS"),
                                "CHECK_DATES" => "Y",
                                "DETAIL_URL" => "",
