	...
	foreach($arHeads as $kH => $kV){
		if(isset($val['props'][$kH]['LINK_IBLOCK_ID']) && !empty($val['props'][$kH]['LINK_IBLOCK_ID']) && !empty($val['props'][$kH]['VALUE'])){
			...
			if(is_array($val['props'][$kH]['VALUE'])){
				...
				$myArray[$kH] = str_replace("&quot;","\"",htmlspecialchars_decode($arIbRes[$val['props'][$kH]['VALUE']]));
			}
			...
			if(is_array($val['props'][$kH]['VALUE'])){
				...
				$val['props'][$kH]['VALUE'] = str_replace(";",",",str_replace(array('\"',),'',$val['props'][$kH]['VALUE']));
				$val['props'][$kH]['VALUE'] = str_replace(array("\r\n", "\r", "\n"), '', $val['props'][$kH]['VALUE']);
				$myArray[$kH] = str_replace("&quot;","\"",htmlspecialchars_decode($val['props'][$kH]['VALUE']));
			}
		}
