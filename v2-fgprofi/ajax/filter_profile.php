...
//		}
        ...
        if ($arData["DATE_OF_BIRTH"] != "") {
            $arFilter["PROPERTY_DATE_OF_BIRTH"] = "%" . $arData["DATE_OF_BIRTH"] . "%";
            unset($arData["DATE_OF_BIRTH"]);
        }
        if ($arData["EMAIL"] != "") {
            $arFilter["PROPERTY_EMAIL"] = "%" . $arData["EMAIL"] . "%";
            unset($arData["EMAIL"]);
        }
        if ($arData["SOC"] != "") {
            $arFilter["PROPERTY_SOC"] = "%" . $arData["SOC"] . "%";
            unset($arData["SOC"]);
        }
        if ($arData["POSITION"] != "") {
            $arFilter["PROPERTY_POSITION"] = "%" . $arData["POSITION"] . "%";
            unset($arData["POSITION"]);
        }
        if ($arData["SIFLAS"] != "") {
            $arFilter["PROPERTY_SIFLAS"] = "%" . $arData["SIFLAS"] . "%";
            unset($arData["SIFLAS"]);
        }
        if ($arData["INN"] != "") {
            $arFilter["PROPERTY_INN"] = "%" . $arData["INN"] . "%";
            unset($arData["INN"]);
        }
        if ($arData["KPP"] != "") {
            $arFilter["PROPERTY_KPP"] = "%" . $arData["KPP"] . "%";
            unset($arData["KPP"]);
        }
        if ($arData["OGRN"] != "") {
        ...
        if ($arData["ACTUAL_ADDRESS"] != "") {
            $arFilter["PROPERTY_ACTUAL_ADDRESS"] = "%" . $arData["ACTUAL_ADDRESS"] . "%";
            unset($arData["ACTUAL_ADDRESS"]);
        }
        if ($arData["PHONE"] != "") {
            $arFilter["PROPERTY_PHONE"] = "%" . $arData["PHONE"] . "%";
            unset($arData["PHONE"]);
        }
        if ($arData["SITE_PAGE"] != "") {
            $arFilter["PROPERTY_SITE_PAGE"] = "%" . $arData["SITE_PAGE"] . "%";
            unset($arData["SITE_PAGE"]);
        }
        if ($arData["ADDITIONAL_INFORMATION"] != "") {
            $arFilter["PROPERTY_ADDITIONAL_INFORMATION"] = "%" . $arData["ADDITIONAL_INFORMATION"] . "%";
            unset($arData["ADDITIONAL_INFORMATION"]);
        }
                    ...
                    <div class="filter__right" data-id="' . $ob["ID"] . '">
						<div class="filter__label-wrap">
							<label class="filter__label label-filter label-filter_lock">
								<input class="filter__input" data-status="block" type="checkbox" ' . $checked . '>
						...
						<div class="filter__label-wrap">
							<label class="filter__label label-filter label-filter_trash' . $delTrash . '">
								<input class="filter__trash" data-status="delete" type="checkbox"'.$delTrashChecked.'>
							</label>
							<span class="label-filter__tooltip">Удаление</span>
						</div>
						<div class="filter__label-wrap">
							<label class="filter__label label-filter label-filter_changes">
								<input class="filter__change-pass" data-status="pass" type="checkbox">
							</label>
