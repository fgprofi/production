                ...
                <ul class="sidebar__list">
                    ...
                    <li class="sidebar__item">
                        ...
                        <div class="sidebar__tab-content">
                            <a class="sidebar__link sidebar__link-tab" href="/admin/subscribe/mailer/main/">Мои рассылки</a>
                            ...
                            <a class="sidebar__link sidebar__link-tab" href="/admin/subscribe/mailer/#tab-template">Мои шаблоны</a>
                            <a class="sidebar__link sidebar__link-tab" href="/admin/subscribe/mailer/#tab-history">Архив рассылок</a>
                        </div>
                    </li>
                    <li class="sidebar__item">
