...
<form method="post" action="<?= $arResult["NEW_TICKET_PAGE"] ?>">
	<input class="link link-button" type="submit" name="edit" value="<?= GetMessage("SUP_ASK") ?>">
</form>
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"HEADERS" => array(
				...
				array("id" => "OWNER_LOGIN", "name" => "Инициатор", "default" => true),
				//array("id" => "OWNER_SID", "name" => "Email инициатора", "default" => true),
				//array("id" => "MARK_NAME", "name" => "Оценка ответов", "default" => true),
			),
			"SORT" => $arResult["SORT"],
