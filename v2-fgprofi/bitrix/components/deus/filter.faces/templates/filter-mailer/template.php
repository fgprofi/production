...
<form class="all_user user-search__form" action="">
    ...
    <div class="filter_face">
        <?if(isset($arParams["PROPERTIES"]["TYPE_F"])):?>
            <label><input type="hidden" value="TYPE_F" name="FACE" checked>Физическое лицо</label>
        <?endif;?>
        <?if(isset($arParams["PROPERTIES"]["TYPE_U"])):?>
            <label><input type="hidden" value="TYPE_U" name="FACE" checked>Юридическое лицо</label>
        <?endif;?>
    </div>
