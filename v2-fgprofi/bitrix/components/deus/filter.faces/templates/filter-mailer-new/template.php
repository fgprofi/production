...
<?/*//поле для фильтрации пользователей по фио(и обязательным полям)*/?>
<form action class="newsletter-search__form filter_byFio">
    ...
    <input type="text" class="newsletter-search__input newsletter__form-input" name="item_users" placeholder="Поиск">
</form>
...
<div class="full_filter_box">
    ...
    <div class="full_filter" style="display:block;">
        ...
        foreach ($arResult["PROPS"] as $keyFace => $face) : ?>
            ...
            $i++; ?>
            <form action="" class="form_filter<?= $actionForm ?> mailer_filter" data-face="<?= $keyFace ?>">
...
<a href="#save-audience" rel="nofollow" class="link link-button link-button--transparent fancybox-popup__link save-audience-popup">Сохранить как аудиторию</a>
...
<div class="filter">
    <div class="filter__head">
        ...
        <div class="filter__right">
            <form action="/admin/subscribe/mailer/send/" method="post">
                <textarea name="select_users" style="display: none;"></textarea>
                <a class="link link-button send-check-users link-button--disabled">Написать</a>
            </form>
        </div>
    </div>
    <?
...
<div id="none-users-popup">
    <div class="none-users-popup-text">
        Выберите пользователей аудитории!
        <a class="none-users-popup-btn">
            <div class="button-green">
                Да
            </div>
        </a>
