...
$countResultJson = count($arResultJson['id']);
?>
<div class="total-user">Найдено пользователей: <b class="total-user-val"><?=$countResultJson?></b></div>
<form class="subscribe-great-form">
    <textarea name="users-id" style="display:none;"><?=implode(",",$arResultJson['id']);?></textarea>
    <div class="form_input">
        <div class="form__input-name">Тип рассылки</div>
        <div class="form_select">
            <select name="SUBSCRIBE_TYPE" class="jsFilterSelect">
                <option value="1">Мнение</option>
                <option value="2">Реклама</option>
            </select>
        </div>
    </div>
    <div class="form_input input_box required">
        <div class="form__input-name">Тема письма</div>
        <input type="text" class="auto_text" autocomplete="off" name="THEME_MAIL" placeholder="Тема письма">
    </div>
    <div class="form_input input_box required">
        <div class="form__input-name">Описание рассылки</div>
    ...
    <div class="send-subscribe">Отправить</div>
</form>
<div id="popup-subscribe">
    <div class="subscribe-popup-text">
        ...
        <div class="button-green btn-popup-close">
            Отмена
        </div>
    </div>
</div>
